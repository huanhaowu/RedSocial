  ...
  async function getAllPost() {
    try {
      const { data: Post, error: postError } = await supabase
        ...
        .range((page - 1) * 1, page * 1); // Fetch 10 items per page
        ...
        <div className="ml-96 w-3/5">
          <div className="mt-6 bg-white rounded-md right-20 p-6 h-fit w-full ">
            <form id="textForm" onSubmit={handlePostSubmit}>
              {/* Your post input form */}
              <label className="flex text-lg font-semibold" htmlFor="textInput">
              ...
              <div className="mt-4 flex justify-end">
                <button className="bg-blue-400 w-24 rounded-md flex items-center justify-center hover:bg-blue-500 text-white font-semibold py-1 px-6" type="submit">
                  Submit
                </button>
              </div>
            </form>
          ...
          <InfiniteScroll
            dataLength={posts.length} // This is important
            next={() => setPage(page + 1)} // Load the next page when the user scrolls to the bottom
            hasMore={true} // Set this to true if there is more data to load
            loader={<h4>Loading...</h4>} // Display a loading indicator
          >
